...
class ViewController: UIViewController, UITableViewDelegate {
    ...
    var tableData = ["Camera", "Music", "Gear"]
    ...
    func tableView(UITableView!, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        var cell = tableVeiw!.dequeueReusableCellWithIdentifier(self.cellIdentifier) as UITableViewCell
    ...
    override func viewDidLoad() {
        ...
        self.tableVeiw.registerClass(UITableViewCell.self, forCellReuseIdentifier: self.cellIdentifier)
    }
